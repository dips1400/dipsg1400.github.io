...
<div class="container">
	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      ...
	      <ul class="nav navbar-nav navbar-right">
	      	<li class="active"><a href="/ubuntu/shopping2/view_cart.php"><span class="badge"><?php echo count($_SESSION['cart']); ?></span> Cart <span class="glyphicon glyphicon-shopping-cart"></span></a></li>
	      </ul>
	    </div>
	  </div>
	</nav>
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			?>
			<form method="POST" action="/ubuntu/shopping2/save_cart.php">
			<table class="table table-bordered table-striped">
				...
				<tbody>
					<?php
						...
						$sql = "SELECT * FROM shopping_cart WHERE cid IN (".implode(',',$_SESSION['cart']).")";
						$result = pg_query($conn,$sql);
							while($row = pg_fetch_assoc($result)){
								?>
								<tr>
									<td>
										<a href=delete_item.php?id=<?php echo $row['cid']; ?>&index=<?php echo $index; ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
									</td>
